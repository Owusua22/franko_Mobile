...
// Product Card Component – unified UI (spinner, SALE, floating heart, red cart FAB)
const ProductCard = ({
  product,
  onWishlistToggle,
  onAddToCart,
