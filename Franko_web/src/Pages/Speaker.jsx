...
const SCROLL_KEY = "speakersScrollY";
...
const Speakers = () => {
  ...
  // Fetch products & restore scroll position (Phones-style)
  useEffect(() => {
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#166534] max-w-sm">
                      We couldn't find any speakers matching your filters. Try
