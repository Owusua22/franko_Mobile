...
const SCROLL_KEY = "fridgeScrollY";
...
const Fridge = () => {
  ...
  // Fetch products & restore scroll position (like Phones/Laptops above)
  useEffect(() => {
  ...
  const headerTitle = selectedBrandName
    ? `${selectedBrandName} Refrigerators`
    : "Refrigerators";
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#166534] max-w-sm">
                      We couldn't find any refrigerators matching your filters.
