...
const Television = () => {
  ...
  // Fetch products & restore scroll position (same pattern as above)
  useEffect(() => {
  ...
  const headerTitle = selectedBrandName ? `${selectedBrandName} TVs` : "Televisions";
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#166534] max-w-sm">
                      We couldn't find any televisions matching your filters.
