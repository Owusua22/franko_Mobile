...
const SCROLL_KEY = "laptopsScrollY";
...
const Laptops = () => {
  ...
  // Fetch products & restore scroll position if saved (same behavior as Phones)
  useEffect(() => {
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#166534] max-w-sm">
                      We couldn't find any laptops matching your filters. Try
