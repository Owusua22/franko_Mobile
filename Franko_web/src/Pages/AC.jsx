...
const SCROLL_KEY = "airConditionersScrollY";
...
const Airconditioners = () => {
  ...
  // Fetch products & restore scroll position (same as the "above" pages)
  useEffect(() => {
  ...
  const headerTitle = selectedBrandName
    ? `${selectedBrandName} Air Conditioners`
    : "Air Conditioners";
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#166534] max-w-sm">
                      We couldn't find any air conditioners matching your
