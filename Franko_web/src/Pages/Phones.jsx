...
const SCROLL_KEY = "phonesScrollY";
...
const Phones = () => {
  ...
  // Fetch products & restore scroll position if saved
  useEffect(() => {
  ...
  const filteredProducts = sortProducts(
    products.filter((p) => {
      ...
      const matchesBrand = selectedBrandName
        ? p.brandName === selectedBrandName
        : true;
  ...
  const renderFilterContent = () => (
    <div className="w-full lg:w-72 space-y-4">
      ...
      {/* Filter by Brand – same logic for mobile & tablet/desktop */}
    ...
    <div className="min-h-screen bg-white pb-16">
      <div className="px-3">
        ...
        <div className="flex flex-col md:flex-row gap-4 mt-4">
          {/* Tablet/Desktop Sidebar – same filter/brand logic as mobile */}
          ...
          <section className="flex-1">
            ...
            {showProducts && (
              <div className="space-y-3">
                <div>
                  <ProductCard
                    /* show all filtered products, no pagination */
                ...
                <div className="flex flex-col items-center text-center space-y-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-[#166534] max-w-sm">
                      We couldn't find any phones matching your filters. Try
